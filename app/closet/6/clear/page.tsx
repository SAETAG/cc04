...
import { Volume2, VolumeX, Home, Trophy, ArrowRight, Ruler, Star, Beer } from "lucide-react"

export default function Stage6ClearPage() {
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-gradient-to-b from-purple-900 to-teal-900 rounded-lg p-6 border-2 border-yellow-500 shadow-lg text-center">
          ...
          <p className="text-white text-lg sm:text-xl mb-6">
            おめでとうございます！「未練の洞窟」ステージをクリアしました。
            <br />
            あなたは「運命の箱」の中身を再度見直し、本当に必要なものだけを残すことができました。
          </p>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 bg-yellow-500 bg-opacity-30 rounded-full flex items-center justify-center">
                  <Ruler className="w-8 h-8 sm:w-10 sm:h-10 text-yellow-300" />
                </div>
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-bold text-yellow-300">空間測定のルーン</h3>
                  <p className="text-white text-sm sm:text-base">
                    空間を正確に測定し、最適な収納方法を導き出す古代の魔法
                  </p>
                </div>
              </div>
