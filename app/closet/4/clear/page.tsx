...
import { Volume2, VolumeX, Home, Trophy, ArrowRight, Sword, Star, Beer } from "lucide-react"

export default function Stage4ClearPage() {
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-gradient-to-b from-purple-900 to-teal-900 rounded-lg p-6 border-2 border-yellow-500 shadow-lg text-center">
          ...
          <p className="text-white text-lg sm:text-xl mb-6">
            おめでとうございます！「選ばれし者」ステージをクリアしました。
            <br />
            あなたはクローゼットに戻すべきお気に入りのアイテムを選び出しました。
          </p>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex-shrink-0 mr-4 bg-yellow-500 rounded-full p-3">
                  <Sword className="h-8 w-8 text-purple-900" />
                </div>
                <div className="text-left">
                  <h3 className="text-lg font-bold text-yellow-300">断捨の剣・極</h3>
                  <p className="text-white text-sm">不要なものを見極め、迷いなく断ち切る伝説の剣</p>
                </div>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/pub">
              <Button className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-bold py-3 px-6 rounded-lg border border-amber-400 shadow-lg flex items-center gap-2">
